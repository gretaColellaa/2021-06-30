...
class View(ft.UserControl):
    ...
    def load_interface(self):
        # title
        self._title = ft.Text("ESAME DEL 20/06/2021", color="blue", size=24)
        ...
        row1 = ft.Row([self.dd_localizzazione,self.btn_statistiche, self.btn_cammino],
